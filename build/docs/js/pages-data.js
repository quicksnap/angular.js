...
angular.module('pagesData', [])
  ...
  "api/ng/function/angular.copy": {
    ...
    "searchTerms": {
      ...
      "keywords": "$scope angular api argument arguments array class controller copied copy created creates deep deleted destination e-mail elements email example example-example examples exception function gender html identical including js json lang-html language master module ng ng-click ng-controller ng-model novalidate null object objects outputfolder partials primitives properties provided reset returned runnable-example runnable-example-file runnable-example-frame source src supplied thrown type undefined update updated user"
    }
  },
  ...
  "api/ng/service/$anchorScroll": {
    ...
    "searchTerms": {
      ...
      "keywords": "$anchorscroll $anchorscrollprovider $location $rootscope $scope $window anchor anchorscroll api auto block bottom call called calling changes checks class css current disableautoscrolling disabled display element example-example2 examples function gotobottom hash height html js lang-css lang-html lang-js language location margin-top match module ng ng-click ng-controller org outputfolder overflow partials rules runnable-example runnable-example-file runnable-example-frame script scroll scrollarea scrollctrl scrolls service set spec src style the-indicated-part-of-the-document type w3 watches"
    }
  },
  ...
  "api/ng/directive/ngHref": {
    ...
    "searchTerms": {
      ...
      "keywords": "angular api attribute attributes base behaviors booleanattrs broken browser chance change class clear click clicks combinations correct directive don driver element empty error example example-example4 examples execute expect function getattribute getcurrenturl gravatar href html http js lang-html lang-js language link links location markup match model module navigate ng ng-click ng-href ng-model nghref outputfolder partials point problem protractor reload replace replaces return runnable-example runnable-example-file runnable-example-frame sendkeys solves src string tobe toequal tomatch type url user wait webdriver write wrong xit"
    }
  },
  ...
  "api/ng/directive/ngDisabled": {
    ...
    "searchTerms": {
      ...
      "keywords": "absence angular api attribute attributes binding boolean booleanattrs browser browsers button chrome class click complementary css directive disabled element enabled example-example5 examples expect expression false function getattribute guide html ie8 ies input interpolation isdisabled js lang-html lang-js language lost markup model module ng ng-disabled ng-init ng-model ngdisabled older outputfolder partials permanent place presence preserve problem protractor reliable removed removes require runnable-example runnable-example-file runnable-example-frame scope set solves special specification src store tobefalsy tobetruthy toggle true truthy type values"
    }
  },
  ...
  "api/ng/input/input[radio]": {
    ...
    "searchTerms": {
      ...
      "keywords": "$scope angular api assignable binding blue button change changes class click color control ctrl data-bind element example-radio-input-directive examples executed expect expression form function gettext green html input interaction item js json lang-html lang-js language model module ng ng-controller ng-model ng-value ngchange ngmodel ngvalue note outputfolder partials property protractor published radio radio-input-directive red runnable-example runnable-example-file runnable-example-frame selected set sets specialvalue src tocontain type user var"
    }
  },
  "api/ng/input/input[checkbox]": {
    ...
    "searchTerms": {
      ...
      "keywords": "$scope angular api assignable binding change changes checkbox checkbox-input-directive class click control ctrl data-bind element example-checkbox-input-directive examples executed expect expression form function gettext html input interaction js lang-html lang-js language model module ng ng-controller ng-false-value ng-model ng-true-value ngchange ngfalsevalue ngmodel ngtruevalue outputfolder partials property protractor published runnable-example runnable-example-file runnable-example-frame selected set src tocontain true type user value1 value2 var"
    }
  },
  ...
  "api/ng/directive/ngChange": {
    ...
    "searchTerms": {
      ...
      "keywords": "$scope api binding change changes changing class click coming controller counter debug directive element evaluate evaluated event example-ngchange-directive examples expect expression form function gettext guide html input javascript js key lang-html lang-js language leaves model module ng ng-change ng-controller ng-model ngchange ngchange-directive ngmodel note onchange outputfolder partials presses protractor requires return runnable-example runnable-example-file runnable-example-frame src tocontain triggers type user var view"
    }
  },
  "api/ng/directive/ngList": {
    ...
    "searchTerms": {
      ...
      "keywords": "$error $scope $valid api array binding class clear comma converted converts css ctrl default delimited delimiter directive element empty error example-nglist-directive examples expect expression fixed form function getcssvalue gettext html initialize input invalid js lang-html lang-js language list listinput model module names namesinput ng ng-controller ng-list ng-model ng-show nglist nglist-directive optional outputfolder partials protractor regular required runnable-example runnable-example-file runnable-example-frame sendkeys split src string strings text tobe tocontain type valid var"
    }
  },
  ...
  "api/ng/directive/ngClassOdd": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac api applied array blue check class color column conjunction css delimited directive directives eval evaluation exactly example-example17 examples expect expression function getattribute guide html js lang-css lang-html lang-js language module names ng ng-class-even ng-class-odd ng-init ng-repeat ngclass ngclasseven ngclassodd ngrepeat odd outputfolder partials protractor red repeater representing result row rows runnable-example runnable-example-file runnable-example-frame scope space src string style tomatch type work"
    }
  },
  "api/ng/directive/ngClassEven": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac api applied array blue check class color column conjunction css delimited directive directives eval evaluation exactly example-example18 examples expect expression function getattribute guide html js lang-css lang-html lang-js language module names ng ng-class-even ng-class-odd ng-init ng-repeat ngclass ngclasseven ngclassodd ngrepeat odd outputfolder partials protractor red repeater representing result row rows runnable-example runnable-example-file runnable-example-frame scope space src string style tomatch type work"
    }
  },
  "api/ng/directive/ngCloak": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac add addition alternatively angular angular-csp api application applied apply attribute avoid best browser browsers caused children class compilation compiled cooperation csp css deletes directive directives display displayed document element elements embedded encounters example example-example19 examples expect external file flicker form function getattribute head hidden html ie7 included js lang-html lang-js language legacy limitation loaded loading making match min mode module multiple ng ng-cloak ngcloak ngcsp outputfolder partials permit portions preferred prevent progressive protractor provide raw remove rendering result rule runnable-example runnable-example-file runnable-example-frame script selector small src stylesheet support tagged template template1 template2 tobenull type undesirable usage view visible work works x-ng-cloak"
    }
  },
  ...
  "api/ng/directive/ngClick": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event allows api behavior binding check class click clicked count css custom directive element evaluate example-example22 examples expect expression function gettext guide html increment js lang-html lang-js language module ng ng-click ng-init ngclick ngeventdirs object outputfolder partials protractor runnable-example runnable-example-file runnable-example-frame src tomatch type"
    }
  },
  "api/ng/directive/ngDblclick": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event allows api behavior class click count custom dblclick directive double evaluate event example-example23 examples expression guide html increment js lang-html language module ng ng-dblclick ng-init ngdblclick ngeventdirs object outputfolder partials runnable-example runnable-example-file runnable-example-frame src type"
    }
  },
  "api/ng/directive/ngMousedown": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event allows api behavior class count custom directive evaluate event example-example24 examples expression guide html increment js lang-html language module mouse mousedown ng ng-init ng-mousedown ngeventdirs ngmousedown object outputfolder partials runnable-example runnable-example-file runnable-example-frame src type"
    }
  },
  "api/ng/directive/ngMouseup": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior class count custom directive evaluate event example-example25 examples expression guide html increment js lang-html language module mouse mouseup ng ng-init ng-mouseup ngeventdirs ngmouseup object outputfolder partials runnable-example runnable-example-file runnable-example-frame src type"
    }
  },
  "api/ng/directive/ngMouseover": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior class count custom directive evaluate event example-example26 examples expression guide html increment js lang-html language module mouse mouseover ng ng-init ng-mouseover ngeventdirs ngmouseover object outputfolder partials runnable-example runnable-example-file runnable-example-frame src type"
    }
  },
  "api/ng/directive/ngMouseenter": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior class count custom directive enters evaluate event example-example27 examples expression guide html increment js lang-html language module mouse mouseenter ng ng-init ng-mouseenter ngeventdirs ngmouseenter object outputfolder partials runnable-example runnable-example-file runnable-example-frame src type"
    }
  },
  "api/ng/directive/ngMouseleave": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior class count custom directive evaluate event example-example28 examples expression guide html increment js lang-html language leaves module mouse mouseleave ng ng-init ng-mouseleave ngeventdirs ngmouseleave object outputfolder partials runnable-example runnable-example-file runnable-example-frame src type"
    }
  },
  "api/ng/directive/ngMousemove": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior class count custom directive evaluate event example-example29 examples expression guide html increment js lang-html language module mouse mousemove moves ng ng-init ng-mousemove ngeventdirs ngmousemove object outputfolder partials runnable-example runnable-example-file runnable-example-frame src type"
    }
  },
  "api/ng/directive/ngKeydown": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event altkey api behavior class count custom directive evaluate event example-example30 examples expression guide html interrogated js key keycode keydown lang-html language module ng ng-init ng-keydown ngeventdirs ngkeydown object outputfolder partials runnable-example runnable-example-file runnable-example-frame src type"
    }
  },
  "api/ng/directive/ngKeyup": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event altkey api behavior class count custom directive evaluate event example-example31 examples expression guide html interrogated js key keycode keyup lang-html language module ng ng-init ng-keyup ngeventdirs ngkeyup object outputfolder partials runnable-example runnable-example-file runnable-example-frame src type"
    }
  },
  "api/ng/directive/ngKeypress": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event altkey api behavior class count custom directive evaluate event example-example32 examples expression guide html interrogated js key keycode keypress lang-html language module ng ng-init ng-keypress ngeventdirs ngkeypress object outputfolder partials press runnable-example runnable-example-file runnable-example-frame src type"
    }
  },
  "api/ng/directive/ngSubmit": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event $scope action additionally angular api attributes binding check class click css ctrl current data-action default directive element empty enables enter eval events example-example33 examples expect expression expressions form function getattribute gettext guide hit html ignore input js lang-html lang-js language list module ng ng-controller ng-model ng-submit ngeventdirs ngsubmit object onsubmit outputfolder partials prevents protractor push reloading request runnable-example runnable-example-file runnable-example-frame sending server src strings submit text tobe tocontain type x-action"
    }
  },
  ...
  "api/ng/directive/ngCopy": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior class copied copy custom directive evaluate event example-example34 examples expression guide html input js lang-html language module ng ng-copy ng-init ng-model ngcopy ngeventdirs object outputfolder partials runnable-example runnable-example-file runnable-example-frame select src textarea type window"
    }
  },
  "api/ng/directive/ngCut": {
    ...
    "searchTerms": {
      ...
      "keywords": "$event api behavior class custom cut directive evaluate event example-example35 examples expression guide html input js lang-html language module ng ng-cut ng-init ng-model ngcut ngeventdirs object outputfolder partials runnable-example runnable-example-file runnable-example-frame select src textarea type window"
    }
  },
  ...
  "api/ng/directive/ngStyle": {
    ...
    "searchTerms": {
      ...
      "keywords": "ac allows api black check class click color colorspan conditionally corresponding css directive element evals example-example45 examples expect expression function getcssvalue guide html js lang-css lang-html lang-js language module names ng ng-click ng-style ngstyle object outputfolder partials protractor runnable-example runnable-example-file runnable-example-frame set span src style text tobe type values var"
    }
  },
  ...
  "api/ng/directive/script": {
    ...
    "searchTerms": {
      "titleWords": "script",
      "keywords": "$templatecache api assigned cache class click content css defined directive directives element example-example48 examples expect function gettext guide html inlined inside js lang-html lang-js language load module ng ng-click ng-include nginclude ngroute ngview outputfolder partials protractor runnable-example runnable-example-file runnable-example-frame script set src tag template templateurl text tomatch tpl-content tpl-link type"
    }
  },
  ...
  "api/ng/filter/json": {
    ...
    "searchTerms": {
      "titleWords": "json",
      "keywords": "allows api arrays automatically binding class convert converted curly debugging double example-example54 examples expect filter filtered filters function gettext html javascript js json jsonify lang-html lang-js language module ng notation object objects outputfolder partials primitive protractor runnable-example runnable-example-file runnable-example-frame src string tomatch type types"
    }
  },
  ...
  "api/ng/filter/orderBy": {
    ...
    "searchTerms": {
      "titleWords": "orderBy",
      "keywords": "$scope age angular api array ascending called class comparator control copy ctrl descending determine elements equivalent evaluates example example-example56 examples expression filter friends function getter href html items js lang-html language module ng ng-click ng-controller ng-repeat number object operator optionally order orderby orders outputfolder partials phone predicate predicates prefixed property result reverse runnable-example runnable-example-file runnable-example-frame sort sorted sorting source src string type"
    }
  },
  "api/ng/service/$http": {
    "docType": "service",
  ...
  "api/ng/service/$log": {
    ...
    "searchTerms": {
      "titleWords": "$log",
      "keywords": "$log $logprovider $scope $window api browser button change class console debug debugenabled debugging default enter error example-example60 examples function hit html implementation info js lang-html lang-js language log logctrl logging main message messages module ng ng-click ng-controller ng-model open outputfolder partials purpose runnable-example runnable-example-file runnable-example-frame safely script service simple simplify src text troubleshooting type warn world writes"
    }
  },
  ...
  "api/ng/service/$window": {
    ...
    "searchTerms": {
      "titleWords": "$window",
      "keywords": "$scope $window alert angular api block box browser button class click coding ctrl current defined dependency directive display dogreeting e2e element evaluated example example-example62 examples expression expressions function global globally greeting html inadvertently input javascript js lang-html lang-js language mocked model module ng ng-click ng-controller ng-model ngclick object outputfolder overridden partials problems protractor refer reference removed respect risk runnable-example runnable-example-file runnable-example-frame runner scope sendkeys service src test testability testing tests type variable window world"
    }
  },
  "api/ngAnimate": {
    "docType": "module",
  ...
  "api/ngRoute/directive/ngView": {
    ...
    "searchTerms": {
      ...
      "keywords": "$anchorscroll $location $locationprovider $route $routeparams $routeprovider angular angular-route animate animation animations api attribute autoscroll background black book bookctrl bookid border border-left bottom bring browser call ch1 ch4 changes chapter chapterctrl chapterid choose class click compile complements concurrently configuration configure content controller controlleras correct css cubic-bezier current deps directive disable display eca element enable enter evaluate evaluated example-ngview-directive examples existing expect expression file fixbase function gettext height href html html5 html5mode included including installed js jsfiddle lang-css lang-html lang-js language layout leave left letter links linktext load main mainctrl moby module ng ng-controller ng-enter ng-enter-active ng-leave ng-leave-active ng-view ngroute ngview ngview-directive ngviewexample occur onload outputfolder overflow overview padding params partiallinktext partials path position protractor rendered requires route runnable-example runnable-example-file runnable-example-frame scarlet scope script scroll scrolling service set solid src template templateurl time tomatch top transition true truthy type updated updates var view view-animate view-animate-container viewport width working yields"
    }
  },
  "api/ngRoute": {
    "docType": "module",
  ...
  "api/ngRoute/service/$route": {
    ...
    "searchTerms": {
      "titleWords": "$route",
      "keywords": "$controller $location $locationprovider $q $route $route-service $routeparams $routeprovider $scope $template $timeout additionally angular angular-route api array book bookcntl bookid ch1 ch4 changing chapter chaptercntl chapterid choose class click compile config configure configured conjunction content controller controllers correct css current deep-linking defer define definition delay deps directive element example example- examples existing expect fixbase function gettext hash href html html5 html5mode inlined installed instantiation js jsfiddle lang-html lang-js language letter links linktext load locals maincntl map match moby module ng ng-controller ng-view ngroute ngrouteexample ngview note outputfolder params partial partiallinktext partials path promise protractor pulls reference requires resolve resolved return route routes runnable-example runnable-example-file runnable-example-frame scarlet scope script second service src template templates templateurl tomatch true type typically url urls values var views watches working"
    }
  },
  ...
  "guide/controller": {
    ...
    "searchTerms": {
      ...
      "keywords": "$controller $new $rootscope $route $scope access add adding allows angular angularjs annotation app application argument arguments assigned assigning assignment associate associating attach attached attaches attaching augment augmented automatically baby beforeeach behavior belong best binding blue border box business button buttons called capital cases child childctrl children childscope chili chilispicy class clicked code common components computation concepts consisting constant controller controllers controls convention conventions correctly create created creates css ctrl customspice data-binding data-bound databinding default defined defines definition demonstrated dependency depending describe di direct directive directives discussed div docs doesn dom double doublecontroller doubles element encapsulate encapsulating ends equals evening event events example example-example78 example-example79 example-example80 examples execute exists expect explicitly expression expressions filter filters food form format forms function functions general gingerbreak global grandchildctrl grandchildscope greeting greetingcontroller guide habanero handler hierarchy higher hola hot html illustrate implicitly inherit inheritance inherits initial injectable injecting injection input instances instantiate invoked involves jalape jalapeno jalapenospicy javascript js lang-css lang-html lang-js language lava length letter levels life-cycle logic mainctrl mainscope manage manipulate manipulation manual mattie message method methods mild model module morning myapp mycontroller named naming needed nested ng ng-click ng-controller ng-model ngclick ngcontroller ngdoc ngroute nikki notice num number object objects order org output outputfolder overrides overview padding parameter partials pasilla passes plain point presentation presented previous primitives properties property provide provided putting react real receives recommended refers registered replaced result return root runnable-example runnable-example-file runnable-example-frame scope scopeinheritance scopes second sections selected service services set setting share shouldn simple single slim solid spice spiceiness spiceness spices spiciness spicy spicyapp1 spicyapp2 spicyctrl src starts string takes template templates test testability testing things three timeofday times tobe type typically understanding updated updates values var variation view ways work works"
    }
  },
  "guide/css-styling": {
    "docType": "overview",
  ...
  "guide/expression": {
    ...
    "searchTerms": {
      ...
      "keywords": "$30 $eval $index $parse $rootscope $scope $window accept access accidental addexp alert alertdialog allow angular application binding bindings browser bugs button calculate call class click clutter cntl1 cntl2 code common complex conditional conditionals context control controller controllers core count css data default defined delegate dialogs differences displaying docs element eval evaluate evaluated evaluating evaluation evaluations example example-example94 example-example95 example-example96 examples exception exceptions expect explicitly expr expression expressions exprs filters flow forgiving format function general generates gettext global greet guide handle href html intentional invoking items javascript javascript-like js lang-html lang-js language lis logic loop loops method names ng ng-bind ng-click ng-controller ng-model ng-repeat ngdoc null object outputfolder overview params partials philosophy prevents processes properties protractor purpose push reason refer referenceerror removeexp repeater response restriction return returns runnable-example runnable-example-file runnable-example-frame safari scope script sense server service simply size snippets source splice src statement statements subtle switchto testing throw throws tobe toequal track type typeerror ul undefined user valid var view views waiting wasn window world write"
    }
  },
  "guide/filter": {
    "docType": "overview",
  ...
  "guide/module": {
    ...
    "searchTerms": {
      "titleWords": "Modules",
      "keywords": "$compileprovider $filterprovider $injector $provide $scope $window accidental add advantage advantages alert alert-info alertspy angular api app application applications applied applies apply approach apps array assume asynchronous basics beforeeach beware block blocks bootstrap bootstrapped bootstrapping bootstraps box break calling class closest code collection component components concise config configuration configure configured consist constant constants container controller controllers convenience create created createspy creating creation deal declarative declaratively declare declared defined definition definitions delay dependencies depending depends describe directive directivename directives docs document don easier effectively empty end-to-end equivalent error example example-example104 example-example105 examples execute executed execution existing expect factory fast feature filter filtername filters focused form fully function going google greet greeter greeting greetmod guide hard hello help html hurry ignored implies initialization inject injected injector inline instance-injector instances instantiates instantiating instantiation isolated jasmine js kickstart kinds lang-html lang-js language large level list load loaded loaders loading localization localize main managing method methods mock module modules multiple myapp myappmodule mydirective mymodule myothermodule myservice named ng-app ng-controller ngdoc notice order organize outputfolder override overrides overriding overview overwrite overwrites package parallel parallelize partials parts phase prevent process projects property provider provider-injector providers real reason recommend recommended reference register registered registrations relevant require required requiring retrieval retrieve return reusable runnable-example runnable-example-file runnable-example-frame runner salutation scale script scripts service services setup simple simplest small special src stimulus structured subset suggestion system tailor test testing tests thing things throws time times tohavebeencalledwith true type typically understand unit unit-test unit-tests user var ve version versus vm window wires working world write written xmpl xmplcontroller"
    }
  },
  "guide/providers": {
    "docType": "overview",
  ...
  "guide/services": {
    ...
    "searchTerms": {
      "titleWords": "Services",
      "keywords": "$http $inject $injector $interval $location $log $on $provide $rootscope $route $routechangesuccess $scope $window add alert alert-error alert-info alert-success allows angular angularjs annotate annotation api app application applications args argument array auto batchlog batchmodule beforeeach body browser built-in callcount called callnotify care change checking class clear click code component config console constructs controller core create createspy creating creating-services current custom declare declaring define dependencies dependency dependent depends determine developers di directive docs don element example example-example109 example-example110 examples expect explicit explicitly factory filter flushed free function generated generates getattribute guide hevery html identifiers implicit implicitly inject injected injection injector inline inside instance instantiated instantiates jasmine javascript join js lang-html lang-js language lazily length ll log logged logs memory message messagequeue messages methods mock model module modules monitors mostrecentcall msgs mycontroller mymodule myservicemodule myservicemoduledi names ng ng-click ng-controller ng-init ng-model ngdoc ngroute notation note notification notifications notify null object objects offers order org organize outputfolder overview parameter partials periodic plan practice property protractor push queued real reference register registered registering renamed represents rest return returned rewrite routetemplatemonitor runnable-example runnable-example-file runnable-example-frame script seconds service serviceid services share shinynewserviceinstance signature simple single singletons specifies spy src start substitutable subsystem takes technique techniques template test testing tests third three times toequal tohavebeencalled tohavebeencalledwith topics type typically unit var variable wikipedia win wired"
    }
  },
  "guide/templates": {
    "docType": "overview",
